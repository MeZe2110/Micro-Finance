package tn.esprit.fundsphere.Controllers.InvestmentRestController;
...
import tn.esprit.fundsphere.Services.InvestmentService.InvestmentService;
...
@PutMapping("/invest/{id_user}/{amount}/{id_invest}")
    Investment invest(@PathVariable("id_user") Long account_id,@PathVariable("amount")Float amount,@PathVariable("id_invest")Integer id_invest) throws MessagingException {
...
@PutMapping("/accept/{id}")
 ...
 @PutMapping("/check")
    void CheckInvestment() throws MessagingException {
